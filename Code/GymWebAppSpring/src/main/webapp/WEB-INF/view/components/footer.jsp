        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    <p>
                        <a href="/client" class="text-reset">Mi area personal</a>
                    </p>
                    <p>
                        <a href="/entrenador/clientes" class="text-reset">Mis clientes</a>
                    </p>
                    <p>
                        <a href="/entrenador/rutinas" class="text-reset">Mis rutinas</a>
                    </p>
                </div>
                <!-- Grid column -->
